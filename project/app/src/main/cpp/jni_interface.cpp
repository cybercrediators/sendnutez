...
Java_send_nutez_Prediction_YOLOv5_init(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
Java_send_nutez_Prediction_YOLOv5_detect(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
    auto result = YoloV5::detector->detect(env, image, threshold, nms_threshold);

    auto box_cls = env->FindClass("send/nutez/Prediction/Box");
...
// ***************************************[ Yolov5 Custom Layer ]****************************************
extern "C" JNIEXPORT void JNICALL
Java_send_nutez_Prediction_YOLOv5_initCustomLayer(JNIEnv *env, jclass, jobject assetManager, jboolean useGPU) {
...
extern "C" JNIEXPORT jobjectArray JNICALL
Java_send_nutez_Prediction_YOLOv5_detectCustomLayer(JNIEnv *env, jclass, jobject image, jdouble threshold, jdouble nms_threshold) {
